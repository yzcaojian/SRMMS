...
from overall_info import get_server_detailed_info, server_storage_info_list
...
class RAIDInfoWidget(QWidget):
    ...
    def initUI(self):
        ...
        def draw_server_io_line():
            ...
            y_data = [820, 652, 701, 934, 1190, 1330, 1340, 1433, 1672, 1630, 1725, 1720, 1691, 1530, 1284, 1063, 851,
