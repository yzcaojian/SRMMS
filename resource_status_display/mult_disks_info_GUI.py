...
class MultDisksInfoWidget(QWidget):
    ...
    def initUI(self):
        ...
        update_button_icon.addPixmap(QPixmap('./resource_status_display/png/update.png'), QIcon.Normal, QIcon.Off)
        ...
        configuration_button_icon.addPixmap(QPixmap('./resource_status_display/png/configuration.png'), QIcon.Normal, QIcon.Off)
        ...
        def show_warning_list(warning_list):
            ...
            if self.warning_update:
                ...
                update_icon = QIcon()
                update_icon.addPixmap(QPixmap('./resource_status_display/png/update.png'))
