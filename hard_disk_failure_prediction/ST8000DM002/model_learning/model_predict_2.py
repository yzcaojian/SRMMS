...
def predict_2nd(smart_data, smart_id):
    ...
    smart_max = [244110120, 65288, 5869583955, 39385, 489, 438903, 55227, 88016819424, 314552762456]
    smart_min = [0, 0, 116434, 0, 0, 0, 1, 3369440, 144514]
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, tf.train.latest_checkpoint('./resources/hard_disk_failure_prediction/ST8000DM002/model_learning/model_2/'))
...
# max 44784 min 0
# max 297 min 0
# max 281178623968211 min 0
# max 88016819424 min 3369440
# max 314552762456 min 144514
