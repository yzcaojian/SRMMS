...
np.save("HGST HMS5C4040ALE640_data_2_v1.npy", smart)
np.save("HGST HMS5C4040ALE640_label_2_v1.npy", health_state)
np.save("seqlen_2.npy", seqlen)
# writer = csv.writer(file2, 'a+', newline='')
# for record in hdd:
#     writer.writerow(record[1:])  # 无需保留序列号

smart = np.load("HGST HMS5C4040ALE640_data_2_v1.npy")
health_state = np.load("HGST HMS5C4040ALE640_label_2_v1.npy")
