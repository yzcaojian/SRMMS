...
def predict_1st(smart_data, smart_id):
    ...
    smart_max = [5403, 65168, 30082046003, 76, 751305, 162, 48994, 77690256632, 276474980020]
    smart_min = [1, 0, 14212, 18, 0, 0, 1, 0, 2112]
    ...
    with tf.Session() as sess:
        ...
        # 先加载图和参数变量
        saver.restore(sess, tf.train.latest_checkpoint('./resources/hard_disk_failure_prediction/ST8000NM0055/model_learning/model/'))
