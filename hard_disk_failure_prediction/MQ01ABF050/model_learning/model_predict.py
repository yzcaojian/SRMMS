...
def predict_1st(smart_data, smart_id):
    ...
    # 将SAMRT数据按照训练集同样的方式裁剪选择九个特征：3、9、12、191、193、194、197、222、226
    temp = [3, 9, 12, 191, 193, 194, 197, 222, 226]
    index = 0
    delete_col = []
    ...
    smart_max = [2079, 34089, 83, 1090, 80362, 59, 2808, 34094, 309]
    smart_min = [1156, 0, 2, 0, 9, 19, 0, 0, 159]
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, tf.train.latest_checkpoint('./resources/hard_disk_failure_prediction/MQ01ABF050/model_learning/model/'))
