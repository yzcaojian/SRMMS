...
while t > 0:
    if seqlen[t] - seqlen[t - 1] > 30:
        ...
        while s >= t:
            ...
            s -= 1
    t = t - 1
print("经过筛选，将三十天以外的数据全部删除", hdd.shape)  # (6024， 18)
...
np.save("HDS722020ALA330_data_2_v1.npy", smart)
np.save("HDS722020ALA330_label_2_v1.npy", health_state)
np.save("seqlen_2.npy", seqlen)

smart = np.load("HDS722020ALA330_data_2_v1.npy")
health_state = np.load("HDS722020ALA330_label_2_v1.npy")
