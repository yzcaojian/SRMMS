...
print(train_data[20], train_label[20])
print(train_data[99], train_label[99])
...
def trainGRU(initial_learning_rate):
    ...
    with tf.compat.v1.Session(config=config) as sess:
        ...
        # model:  test accuracy:0.906    参数： lr=0.001，每300步衰减10%，batch_size:128，epoch:1000, muilGRU
