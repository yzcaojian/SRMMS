...
def predict_2nd(smart_data, smart_id):
    ...
    temp = [2, 3, 4, 8, 9, 192, 193, 194, 197]
    index = 0
    delete_col = []
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, tf.train.latest_checkpoint('./resources/hard_disk_failure_prediction/HMS5C4040ALE640/model_learning/model_2/'))
