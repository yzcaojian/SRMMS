...
print('序号数量', seqlen.shape)  # (202, )，对应硬盘序列号数量
# for i in del_col:
#     print(hdd[i])
...
np.save("WD30EFRX_data_v1.npy", smart)
np.save("WD30EFRX_label_v1.npy", health_state)
...
health_state = np.load("WD30EFRX_label_v1.npy")
print('测试------------------------')
