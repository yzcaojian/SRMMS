...
@Time : 2021/5/24 10:22
@Author : cao jian
"""

file = open("WD30EFRX_v1.csv")
...
# np.save("WD30EFRX_data_2_v1.npy", smart)
# np.save("WD30EFRX_label_2_v1.npy", health_state)
# np.save("seqlen_2.npy", seqlen)
#
# smart = np.load("WD30EFRX_data_2_v1.npy")
# health_state = np.load("WD30EFRX_label_2_v1.npy")
# print(health_state[0], health_state[1], health_state[2])
# print(smart[2])  # 打印测试程序是否正确
# print(smart.shape)  # (4194, 17)
