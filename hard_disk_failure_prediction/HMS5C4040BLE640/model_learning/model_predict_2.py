...
def predict_2nd(smart_data, smart_id):
    ...
    # 将SAMRT数据按照训练集同样的方式裁剪选择九个特征：1、4、5、9、10、192、193、194、197
    temp = [1, 4, 5, 9, 10, 192, 193, 194, 197]
    index = 0
    delete_col = []
    ...
    smart_max = [193529874, 105, 1999, 46419, 1114112, 33553, 33553, 50, 18752]
    smart_min = [0, 1, 0, 0, 0, 1, 1, 19, 0]
    ...
    with tf.Session() as sess:
        ...
        # 先加载图和参数变量
        saver.restore(sess, tf.train.latest_checkpoint('./resources/hard_disk_failure_prediction/HMS5C4040BLE640/model_learning/model_2/'))
