...
def trainGRU(initial_learning_rate):
    ...
    with tf.compat.v1.Session(config=config) as sess:
        ...
        # model:  test accuracy:0.754    参数： lr=0.001, 每15000步衰减5%，batch_size:300,,epoch:2000, muilGRU
        # model2:  test accuracy:0.708    参数： lr=0.001, 每16000步衰减10%，batch_size:300,,epoch:2000, muilGRU
    ...
    # t = np.arange(int(len(train_data) / batch_size / display_step) * true_epochs)
