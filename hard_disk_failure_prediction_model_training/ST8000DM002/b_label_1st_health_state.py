...
print('序号数量', seqlen.shape)  # (446, )，对应硬盘序列号数量
...
np.save("ST8000DM002_data_v1.npy", smart)
np.save("ST8000DM002_label_v1.npy", health_state)
np.save("seqlen.npy", seqlen)

smart = np.load("ST8000DM002_data_v1.npy")
health_state = np.load("ST8000DM002_label_v1.npy")
print('测试------------------------')
