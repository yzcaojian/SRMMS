...
def trainGRU(initial_learning_rate):
    ...
    learning_rate = tf.compat.v1.train.exponential_decay(initial_learning_rate, global_step=global_step,
                                                         decay_steps=800, decay_rate=0.90)
    ...
    with tf.compat.v1.Session(config=config) as sess:
        ...
        for epoch in range(epochs):
            ...
            test_accuracy = sess.run(accuracy, feed_dict={x: test_data[0:300, :, :],
                                                          y: test_label[0:300, :]})
        ...
        # model_2:  test accuracy:0.921    参数： lr=0.001，每800步衰减10%，batch_size:256，epoch:1000, muilGRU
