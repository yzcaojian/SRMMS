...
# hdd = np.loadtxt("ST12000NM0007_v1.csv", dtype=np.int, delimiter=',', skiprows=1, usecols=range(1, col_len))
# print(hdd.shape)

file = open("ST12000NM0007_v1.csv")
...
print('序号数量', seqlen.shape)  # (1805,)，对应硬盘序列号数量
# for i in del_col:
#     print(hdd[i])
...
np.save("ST12000NM0007_data_v1.npy", smart)
np.save("ST12000NM0007_label_v1.npy", health_state)
np.save("seqlen.npy", seqlen)

smart = np.load("ST12000NM0007_data_v1.npy")
health_state = np.load("ST12000NM0007_label_v1.npy")
print('测试------------------------')
