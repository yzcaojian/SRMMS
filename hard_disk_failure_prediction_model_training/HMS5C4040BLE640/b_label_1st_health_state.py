...
np.save("HGST HMS5C4040BLE640_data_v1.npy", smart)
np.save("HGST HMS5C4040BLE640_label_v1.npy", health_state)
np.save("seqlen.npy", seqlen)

smart = np.load("HGST HMS5C4040BLE640_data_v1.npy")
health_state = np.load("HGST HMS5C4040BLE640_label_v1.npy")
print(health_state[2])
print(smart[2])  # 打印测试程序是否正确
print(smart.shape)  # (150881, 17)
