...
@Description: 标注二级健康度
@Time : 2021/12/2 20:06
@Author : cao jian
"""

file = open("HGST HMS5C4040BLE640_v1.csv")
...
while t > 0:
    if seqlen[t] - seqlen[t - 1] > 30:
        ...
        while s >= t:
            ...
            s -= 1
    t = t - 1
print("经过筛选，将三十天以外的数据全部删除", hdd.shape)
...
np.save("HGST HMS5C4040BLE640_data_2_v1.npy", smart)
np.save("HGST HMS5C4040BLE640_label_2_v1.npy", health_state)
np.save("seqlen_2.npy", seqlen)

smart = np.load("HGST HMS5C4040BLE640_data_2_v1.npy")
health_state = np.load("HGST HMS5C4040BLE640_label_2_v1.npy")
print(health_state[0], health_state[1], health_state[2])
print(smart[2])  # 打印测试程序是否正确
print(smart.shape)  # (7366, 17)
