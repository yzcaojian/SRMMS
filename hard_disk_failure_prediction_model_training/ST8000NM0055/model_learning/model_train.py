...
def trainGRU(initial_learning_rate):
    ...
    learning_rate = tf.compat.v1.train.exponential_decay(initial_learning_rate, global_step=global_step,
                                                         decay_steps=6000, decay_rate=0.9)
    ...
    with tf.compat.v1.Session(config=config) as sess:
        ...
        for epoch in range(epochs):
            ...
            if test_accuracy > 0.90 and acc > 0.99:
        ...
        # model_learning:  test accuracy:0.842    参数： lr=0.001, 每6000步衰减10%，batch_size:300,,epoch:1200, muilGRU
