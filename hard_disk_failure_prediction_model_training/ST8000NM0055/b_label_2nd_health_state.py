...
while t > 0:
    if seqlen[t] - seqlen[t - 1] > 30:
        ...
        while s >= t:
            ...
            s -= 1
    t = t - 1
print("经过筛选，将三十天以外的数据全部删除", hdd.shape)  # (17786, 25)
...
np.save("ST8000NM0055_data_2_v1.npy", smart)
np.save("ST8000NM0055_label_2_v1.npy", health_state)
np.save("seqlen_2.npy", seqlen)

smart = np.load("ST8000NM0055_data_2_v1.npy")
health_state = np.load("ST8000NM0055_label_2_v1.npy")
print(health_state[0], health_state[1], health_state[2])
print(smart[2])  # 打印测试程序是否正确
print(smart.shape)  # (17786, 24)
