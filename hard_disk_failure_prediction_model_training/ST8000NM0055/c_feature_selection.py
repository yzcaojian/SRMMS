...
reader = read_csv('ST8000NM0055_v1.csv', header=0)
...
# true_smart = np.load('ST8000NM0055_data_2_v1.npy')
# feature = smart

print(feature.shape)  # (130123, 24) 一级  (6611, 24) 二级
print(label.shape)
...
for (support, feature, i) in zip(rfe.support_, title, range(len(title))):
    if support:
        ...
        print(feature, end=' ')
# 一级健康度
# smart_4_raw smart_5_raw smart_9_raw smart_187_raw smart_191_raw smart_192_raw smart_193_raw smart_194_raw smart_242_raw
# 二级健康度
# smart_5_raw smart_7_raw smart_9_raw smart_187_raw smart_191_raw smart_193_raw smart_195_raw smart_241_raw smart_242_raw
...
print('\n', smart.shape)
np.save('ST8000NM0055_data_v2.npy', smart)
...
# print('\n', true_smart.shape)
# np.save('ST8000NM0055_data_2_v2.npy', true_smart)
