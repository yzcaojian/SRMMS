...
def trainGRU(initial_learning_rate):
    ...
    with tf.compat.v1.Session(config=config) as sess:
        ...
        for epoch in range(epochs):
            ...
            test_accuracy = sess.run(accuracy, feed_dict={x: test_data[0:batch_size, :, :],
                                                          y: test_label[0:batch_size, :]})
        ...
        # model_2:  test accuracy:0.724   参数： lr=0.001，每1000步衰减10%，batch_size:256，epoch:2000, muilGRU
