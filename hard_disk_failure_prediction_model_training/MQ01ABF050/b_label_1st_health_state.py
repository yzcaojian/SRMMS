...
print('序号数量', seqlen.shape)  # (237, )，对应硬盘序列号数量
...
np.save("TOSHIBA MQ01ABF050_data_v1.npy", smart)
np.save("TOSHIBA MQ01ABF050_label_v1.npy", health_state)
np.save("seqlen.npy", seqlen)

smart = np.load("TOSHIBA MQ01ABF050_data_v1.npy")
health_state = np.load("TOSHIBA MQ01ABF050_label_v1.npy")
print('测试------------------------')
