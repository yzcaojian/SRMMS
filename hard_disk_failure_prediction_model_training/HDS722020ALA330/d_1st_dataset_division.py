...
@Time : 2021/5/24 20:42
@Author : cao jian
"""

# 判断天数，不同天数划分不同的步长
smart = np.load('HDS722020ALA330_data_v2.npy')
...
print(smart.shape)
print('one-hot编码之前标签数组维度为', label.shape)  # (15219, 20)
...
print('one-hot编码之后标签数组维度为', label.shape)  # (15219, 6)
